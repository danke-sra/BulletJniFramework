...
bool is_NULL_vec_field_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	return is_NULL_field_JavaObj(env, java_obj, field_name, "Lorg/gearvrf/bullet/util/Vector3;");
}

bool is_NULL_point_field_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	return is_NULL_field_JavaObj(env, java_obj, field_name, "Lorg/gearvrf/bullet/util/Point3;");
}

bool is_NULL_axis_field_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	return is_NULL_field_JavaObj(env, java_obj, field_name, "Lorg/gearvrf/bullet/util/Axis;");
}

bool is_NULL_pivot_field_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	return is_NULL_field_JavaObj(env, java_obj, field_name, "Lorg/gearvrf/bullet/util/Pivot3;");
}

bool is_NULL_quat_field_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	return is_NULL_field_JavaObj(env, java_obj, field_name, "Lorg/gearvrf/bullet/util/Quaternion;");
}

bool is_NULL_mat3x3_field_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	return is_NULL_field_JavaObj(env, java_obj, field_name, "Lorg/gearvrf/bullet/util/Matrix3x3;");
}
bool is_NULL_mat3x1_field_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	return is_NULL_field_JavaObj(env, java_obj, field_name, "Lorg/gearvrf/bullet/util/Matrix3x1;");
}
...
btVector3 get_vec_by_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	...
	jclass clazz = env->GetObjectClass(java_obj);
	jfieldID vector_fid = env->GetFieldID(clazz, field_name, "Lorg/gearvrf/bullet/util/Vector3;");
...
btVector3 get_point_by_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	...
	jclass clazz = env->GetObjectClass(java_obj);
	jfieldID point_fid = env->GetFieldID(clazz, field_name, "Lorg/gearvrf/bullet/util/Point3;");
...
btVector3 get_pivot_by_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	...
	jclass clazz = env->GetObjectClass(java_obj);
	jfieldID pivot_fid = env->GetFieldID(clazz, field_name, "Lorg/gearvrf/bullet/util/Pivot3;");
...
btVector3 get_axis_by_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	...
	jclass clazz = env->GetObjectClass(java_obj);
	jfieldID axis_fid = env->GetFieldID(clazz, field_name, "Lorg/gearvrf/bullet/util/Axis3;");
...
btQuaternion get_quat_by_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	...
	jclass clazz = env->GetObjectClass(java_obj);
	jfieldID quaternion_fid = env->GetFieldID(clazz, field_name, "Lorg/gearvrf/bullet/util/Quaternion;");
...
btVector3 get_mat3x1_by_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	...
	jclass clazz = env->GetObjectClass(java_obj);
	jfieldID matrix3x1_fid = env->GetFieldID(clazz, field_name, "Lorg/gearvrf/bullet/util/Matrix3x1;");
...
btMatrix3x3 get_mat3x3_by_JavaObj(JNIEnv* env, jobject java_obj, const char* field_name) {
	...
	jclass clazz = env->GetObjectClass(java_obj);
	jfieldID matrix3x3_fid = env->GetFieldID(clazz, field_name, "Lorg/gearvrf/bullet/util/Matrix3x3;");
